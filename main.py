...
def parse_args_and_config():
    ...
    parser.add_argument('--hist_type', type=str, default=None, help='hist_type')
    ...
    namespace_config.data.dataset_config.plane = args.plane
    namespace_config.data.dataset_config.dataset_path = args.dataset_path
    namespace_config.data.dataset_config.hist_type = args.hist_type
